#ifndef INCLUDE_STADO_VECTOR_OPERATIONS_LOOKUP_MASKED_HPP
#define INCLUDE_STADO_VECTOR_OPERATIONS_LOOKUP_MASKED_HPP
...
#endif // INCLUDE_STADO_VECTOR_OPERATIONS_LOOKUP_MASKED_HPP
